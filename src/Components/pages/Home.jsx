    ...
    <div className="relative w-full h-screen text-white font-sans">
      ...
      <div className="absolute top-0 left-0 w-full px-10 pt-10 z-10 flex flex-col space-y-10">
        ...
        <div className="flex items-center justify-center mt-20">
          <h1 className="text-4xl md:text-3xl  font-bold max-w-[600px] ">
            Unlimited movies, TV shows, and more
          </h1>
        </div>
        <p className="font-Poppins">Watch anywhere. Cancel anytime.</p>
        ...
        <input
          ...
          required
          placeholder="Email"
          className="block w-[315px] h-[56px] rounded-md border px-3 py-1.5 text-base text-white outline-1 outline-white placeholder:text-gray-400 focus:outline-2 focus:outline-white"
        />
      </div>
    </div>
  );
